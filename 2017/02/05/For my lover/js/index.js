...
var S = {
    init: function () {
        ...
        if (i !== -1) {
            ...
            S.UI.simulate("献给|我最爱的|机智的|可爱的|迷人的|张忆莲|#countdown 3|Ready!|#love");
...
S.Drawing = (function () {
    ...
    return {
        ...
        adjustCanvas: function () {
            ...
            $(".love").width(window.innerWidth).height(window.innerHeight);
            $(".container").css("margin-top", (window.innerHeight - 500) / 2);
        },
